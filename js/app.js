...
const modalTemplate = `
    <div class="modal">
      ...
      <div class="profileDescriptionModal">
          <div class="profileModal" style="display: flex; flex-direction: column">
              ...
              <span name="descriptionAbility">__DEV_DESCRIPTION_ABILITY__</span>
              <h3>Contato</h3>
...
function fillModal(userInfo) {
  ...
  modal = modal.replaceAll('__DEV_GIT_', userInfo.github);
...
languages = Object.keys(userInfo.languages).map((langCode) => {
  ...
  <div class="languageDescription">
    ...
    <div class="modal-experience">
      <span>${userInfo.language[langCode]}Anos</span>
    </div>
  </div>
`;
}).join("\n");
